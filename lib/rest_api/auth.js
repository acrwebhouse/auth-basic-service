exports.on = function(app) {
    ...
    app.delete(preRestApi + '/removeAccessTokensByUserId', function(req, res) {
        /*#swagger.parameters['obj'] = {
             in: 'body',
             description: 'Remove a access tokens by userId',
             schema: {
         ...
         accessToken.removeAccessTokenByUserId(userId,(result,data)=>{
             response.result = result;
             response.data = data;
             res.send(response)
         });
    ...
    app.get(preRestApi + '/getRefreshTokens', function(req, res) {
        ...
        const response = {
         ...
         refreshToken.getRefreshTokens(id,userId,devices,exp,iat,(result,data)=>{
            response.result = result;
            response.data = data;
            res.send(response)
        });
